...
<meta charset="utf-8">
        ...
        <title>WebsiteName bootstraap template</title>
	...
	<section id="header" class="appear">
		...
		<div class="navbar navbar-fixed-top" role="navigation" data-0="line-height:100px; height:100px; background-color:rgba(0,0,0,0.3);" data-300="line-height:60px; height:60px; background-color:rgba(0,0,0,1);">
				...
				<div class="navbar-header">
					...
					<h1><a class="navbar-brand" href="index.html" data-0="line-height:90px;" data-300="line-height:50px;">WEBSITENAME
					</a></h1>
				</div>
							...
							<div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="0.9s">								
								<form class="form-inline">
									<div class="form-group">
										<button type="livedemo" name="Live Demo" class="btn btn-primary btn-lg" required="required" style="background-color:#333;">Log In</button>
									</div>
									<div class="form-group">
										<button type="getnow" name="Get Now" class="btn btn-primary btn-lg" required="required">Sign Up</button>
									</div>
								</form>
							</div>
						</div>
				    ...
				    <div class="item">
						...
						<div class="carousel-caption">
							...
							<div class="wow fadeInUp" data-wow-offset="0" data-wow-delay="1.6s">								
								<form class="form-inline">
									<div class="form-group">
										<button type="livedemo" name="purchase" class="btn btn-primary btn-lg" required="required" style="background-color:#333;"><span class="glyphicon glyphicon-search" style="margin-right:5px"> </span>Find Jobs</button>
									</div>
            ...
            <div class="col-md-4">
                ...
                <div class="service-box">
					...
					<div class="service-desc">						
						...
						<a href="#" class="btn btn-skin" style="text-transform: none">Browse</a>
					</div>
                </div>
				</div>
            </div>
           ...
           <div class="form-group">
            ...
            <div class="checkbox">
              ...
              <button type="submit" name="loginbutton" class="btn btn-primary btn-block"><span class="glyphicon glyphicon-off"></span> Login</button>
                        ...
                        <button type="submit" class="btn btn-danger  pull-right" data-dismiss="modal" style="background-color:#4169E1; color:white;"> Close</button>
