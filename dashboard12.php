...
var bar = new ProgressBar.Circle(proggcont, {
  color: '#aaa',
  strokeWidth: 4,
  trailWidth: 1,
  easing: 'easeInOut',
...
<div id="backdiv" class="backdiv" style="position:relative;top:100px;">
  ...
  <a class="nd5 nds" data-toggle="modal" data-dismiss="modal" data-placement="left" href="#acheivmodal" ><img class="reminder">
    <p class="letter">A</p>
  </a>
...
<div class="contentside" style="height:75%">
  <div class="header" style="height:100px" >
	...
	<span class="glyphicon glyphicon-user" style="font-size:24px;padding-top:14px;margin-top:20px;"></span>
     ...
     <a href="#persinfomodal" data-toggle="modal" data-dismiss="modal" style="text-decoration-none;color:white"> <span class="glyphicon glyphicon-pencil" style="float:right;font-size:18px;margin-top:-30px;"></span> </a>
	</div>
  
  <div class="divv" style=""><span class="inp1" > <?php echo $row[1].' '.$row[2]?></span></div>
  <div class="divv"><span class="inp1" > <?php echo $row[10]; ?></span></div> 
  ...
  <div class="divv"><span class="inp1" > <?php echo $row[7]; ?></span></div>
   ...
   <div class="divv"><span class="inp1" > <?php echo $row[17]; ?></span></div>
</div>
</div>
	<?php }
	mysqli_close($con);
...
<?php
  ...
  <td style="padding-left:0px;width:60%;">
    <p style="font-size:22px;line-height:28px;color:#34495E;"><a href="#acheivmodal" data-toggle="modal" data-dismiss="modal" style="text-decoration:none;"><span class="glyphicon glyphicon-plus"></span>  <?php echo "Add Acheivements";?> </a><br> </p>
	</td> </tr>
					<?php 
					}
					?>
...
<div class="modal" id="acheivmodal" role="dialog" style="margin-top:-80px;overflow:scroll">
	<div class="modal-dialog" >
	...
	<div class="modal-content" style="width:80%;">
		...
		<div class="modal-header" style="height:60px;background-color:#5D6D7E;color:white;">
                        <button type="button" class="close" data-dismiss="modal">&times;</button>
                        <h3 class="modal-title"></span>Acheivement Form </h3>
                        </div>
	
		
		
		<div class="modal-body" style="height:100%;margin-top:0px;background-color:#D0D3D4;margin-bottom:0px;" >
		<?php  include("acheiv.php");?>
		</div>
