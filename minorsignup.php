...
<script src="js/signstep2.js"></script>
...
<form>
  ...
  <input type="radio"  name="gender" value="male" id="male"   align="center" style="height:4%;width:4%;margin-right:5px;margin-left:60px" onblur="validateGender()" /> <b style="color:white;font-size:15px; margin-right:20px" >Male</b>
  <input type="radio"  name="gender" value="female" id="female"  align="center"style="height:4%;width:4%;margin-right:5px" > <b style="color:white;font-size:15px"> Female</b><br></p>
  </div>
  <div class="popup" >
  <div class="popuptext" id="mypopup1" > </div></div>
  ...
  <div onmouseover="validatedob()" onmouseout="exitcat(this.id)" id="div1">
  
  <select name="DOBDay" class="button1" id="day" style="padding:12px 12px;height:10%;width:19%" align="left">
...
<select name="DOBMonth" id="month" class="button1" style="padding:12px 12px;height:10%;width:30%">
  ...
  <select name="DOBYear" id="year" class="button1" style="padding:12px 12px;height:10%;width:22%">
...
<div class="popup" style="margin-left:50px">
  <div class="popuptext" id="mypopup2" > </div></div>
</div>

<br>
<!--<div class="button">-->
<select name="country" class="countries" id="country" onmouseover="validatecountry()" onmouseout="exitcat(this.id)"  style=" background-color: #50394c;
    border: none;
    color: white;
    padding: 20px 40px;
    text-align: left;
...
<div class="popup" >
  <div class="popuptext" id="mypopup3" > </div></div>

<select name="state" class="states" id="state" onmouseover="validatestate()" onmouseout="exitcat(this.id)" style=" background-color: #50394c;
    border: none;
    color: white;
    padding: 20px 40px;
    text-align: left;
...
<div class="popup" >
  <div class="popuptext" id="mypopup4" > </div></div><br>
<select name="city" class="cities" id="city" onmouseover="validatecity()" onmouseout="exitcat(this.id)" style=" background-color: #50394c;
    border: none;
    color: white;
    padding: 20px 40px;
    text-align: center;
