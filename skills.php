...
<tr class="card" style="border-collapse: collapse;" border="0">
  <td style="width:8%"><img src="skill.png" alt="skill Icon" width="90" style=""></td>
 <td style="padding-left:0px;width:55%;">
    <p style="font-size:22px;line-height:28px;color:#AEB6BF"> Skill ::<br>
      Level::</p>
  </td>
  <td style="width:8%;">
