...
<td cellspacing="0" cellpadding="0" ><a href="http://imgbox.com/NJw97jqr" target="_blank"><img src="https://9-t.imgbox.com/NJw97jqr.jpg" alt="image host" style="margin-left:0px"/></a></td>
                                        ...
                                        <tbody bgcolor="#ABB8C3" width="1200">
											...
											<td colspan="4" align="left" >
                                                    <p style="color:#404040;font-size:28px;line-height:28px;padding-left:40px;padding-top:40px;margin-left:0px;margin-top:0px;">Thank You for signing up for the website websitename</p><br>
                                                    <p style="color:#404040;font-size:20px;line-height:22px;padding:40px;margin-left:0px;padding-top:-20px;">
                                       Hey '.$username.' you are almost ready to get into the world where you get a chance to explore the world full of job opportunities.Please click on the confirmation link to confirm your email address</p>
                                                </td>
                                            </tr>
                                            <tr>
                                            <td colspan="4">
